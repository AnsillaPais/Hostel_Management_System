<?php
   ...
   /* $password=$_POST['password'];
    ...
    $query="INSERT into userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email) values(?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('sssssis',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid);
    $stmt->execute();
