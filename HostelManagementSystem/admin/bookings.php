...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/faviconnew.jpeg">
...
<body style="background: linear-gradient(57deg, #4ca1df, #00e6b3);">
    <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
        <header class="topbar" data-navbarbg="skin6" style="background: linear-gradient(57deg, #2e87c1, #00c6a7);">
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div class="page-wrapper" style="background: linear-gradient(57deg, #4ca1df, #00e6b3);">
            <!-- ============================================================== -->
            ...
            <form method="POST">
                ...
                <h4 class="card-title mt-5" style="color: black; font-weight: bold;">Student's Personal Information</h4>
                ...
                <h4 class="card-title mt-5" style="color: black; font-weight: bold;">Guardian's Information</h4>
                    ...
                    <h4 class="card-title mt-5" style="color: black; font-weight: bold;">Current Address Information</h4>
                    ...
                    <!--<h4 class="card-title mt-5" style="color: black; font-weight: bold;">Permanent Address Information</h4>
                    ...
                    <h5 class="card-title mt-5" style="color: black; font-weight: bold;">Permanent Address</h5>
